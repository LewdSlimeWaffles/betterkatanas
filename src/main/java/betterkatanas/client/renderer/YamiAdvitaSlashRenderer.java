...
public class YamiAdvitaSlashRenderer extends EntityRenderer<YamiAdvitaSlashEntity> {
	...
	@Override
	public void render(YamiAdvitaSlashEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(YamiAdvitaSlashEntity entity) {
		return texture;
	}
}
