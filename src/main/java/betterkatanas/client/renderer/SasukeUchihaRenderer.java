...
public class SasukeUchihaRenderer extends HumanoidMobRenderer<SasukeUchihaEntity, HumanoidModel<SasukeUchihaEntity>> {
	public SasukeUchihaRenderer(EntityRendererProvider.Context context) {
