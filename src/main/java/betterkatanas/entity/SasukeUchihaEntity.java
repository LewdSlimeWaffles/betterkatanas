...
public class SasukeUchihaEntity extends TamableAnimal {
	@SubscribeEvent
	...
	public SasukeUchihaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BetterKatanasModEntities.SASUKE_UCHIHA.get(), world);
	}

	public SasukeUchihaEntity(EntityType<SasukeUchihaEntity> type, Level world) {
		super(type, world);
		xpReward = 50;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SasukeUchihaEntity retval = BetterKatanasModEntities.SASUKE_UCHIHA.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Blocks.NETHER_WART.asItem()).contains(stack.getItem());
	}

	public static void init() {
		SpawnPlacements.register(BetterKatanasModEntities.SASUKE_UCHIHA.get(), SpawnPlacements.Type.ON_GROUND,
